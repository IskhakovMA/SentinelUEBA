...
$frontendManifestHash = (Get-FileHash -Algorithm SHA256 (Join-Path $PackageDir "frontend\frontend-assets.json")).Hash.ToLowerInvariant()
...
Write-Host "FRONTEND_MANIFEST_SHA256=$frontendManifestHash"
